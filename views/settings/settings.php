...
?>
    ...
    <h1><?php 
esc_html_e( "Plugin Settings", 'cf7-message-filter' );
?></h1>

    <div id="km-upload" class="km-upload">
        <div>
			<?php 
_e( "Do you have a CSV file?", 'cf7-message-filter' );
?>
        </div>
        <div>
			<?php 
_e( "DRAG it here or CLICK here to upload it.", 'cf7-message-filter' );
?>
        </div>
...
if ( $suggested_words != '{}' ) {
    ...
    if ( trim( $suggested_words->words ?? '' ) > 0 || trim( $suggested_words->emails ?? '' ) > 0 ) {
        ...
        _e( "Add Suggested Words & Emails", 'cf7-message-filter' );
        ?></button>
                <button class="button button-delete"
                        id="km-ignore-suggestions"><?php 
        _e( "Ignore", 'cf7-message-filter' );
        ?></button>
            </div>
            <div style="margin-top: 10px; display:none" id="km-suggestions-loading">
                <button class="button button-primary"
                        disabled><?php 
        _e( "Please wait...", 'cf7-message-filter' );
        ?></button>
            </div>
		<?php 
    }
...
?>
    ...
    <div style="font-size:15px; margin-top: 20px">
		<?php 
_e( "We have added 8 new filter modifiers", 'cf7-message-filter' );
...
_e( 'Searches only for words ending with “ing” eg. eating,
                walking, talking
                etc…, including the word “ing”.', 'cf7-message-filter' );
?>
            </li>
            <li>
...
_e( 'Searches only for words ending with “ing” eg.
                eating, walking,
                talking etc…, excluding the word “ing”.', 'cf7-message-filter' );
?>
            </li>
            <li>
...
_e( 'Searches only for words starting with “app”. eg
                application, apple,
                including the word “app”', 'cf7-message-filter' );
?>
            </li>
            <li>
...
_e( 'Searches only for words starting with “app”. eg
                application,
                apple, excluding the word “app”', 'cf7-message-filter' );
?>
            </li>
            <li>
...
_e( 'Searches only for words containing “ver”. eg every, Elvera,
                neverland,
                including the word “ver”, words starting with “ver” and words ending with “ver”', 'cf7-message-filter' );
?>
            </li>
...
_e( 'Searches only for words containing “ver”. eg every,
                Elvera,
                neverland, excluding the word “ver”, words starting with “ver” and words ending with “ver”', 'cf7-message-filter' );
?>
            </li>
            <li>
...
_e( ' Searches only for words containing “ver”. eg
                every, Elvera,
                neverland, excluding the word “ver” and words ending with “ver”', 'cf7-message-filter' );
?>
            </li>
            <li>
...
_e( 'Searches only for words containing “ver”. eg
                every, Elvera,
                neverland, excluding words starting with “ver” and the word “ver”', 'cf7-message-filter' );
?>
            </li>
        </ol>
    </div>
...
if ( kmcf7ms_fs()->is_free_plan() || !kmcf7ms_fs()->is_premium() ) {
    ?>
                    Swal.fire({
                        title: '<?php 
    _e( "File Import", 'cf7-message-filter' );
    ?>',
