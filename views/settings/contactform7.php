...
?>
    <h1><?php esc_html_e( "Contact Form 7 Settings ", 'cf7-message-filter' ) ?></h1>
	<?php if ( ! is_plugin_active( 'contact-form-7/wp-contact-form-7.php' ) ): ?>
    <div class="alert alert-danger alert-dismissible">
        <p><?php esc_html_e( 'Please Install & Activate Contact Form 7 Plugin First!', 'cf7-message-filter' ); ?></p>
    </div>
<?php else: ?>
	<?php settings_errors(); ?>
    <div>
